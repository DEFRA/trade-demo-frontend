...
> compatibility fEx: `docker build --platform=linux/arm64 --no-cache --tag trade-demo-frontend`

Build:

```bash
docker build --target development --no-cache --tag trade-demo-frontend:development .
```

Run:

```bash
docker run -p 3000:3000 trade-demo-frontend:development
```
...
```bash
docker build --no-cache --tag trade-demo-frontend .
```

Run:

```bash
docker run -p 3000:3000 trade-demo-frontend
```
